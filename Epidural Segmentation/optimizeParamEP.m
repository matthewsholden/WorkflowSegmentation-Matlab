...
function acc = optimizeParamEP(paramName,param)
...
for i = 1:numVal
    ...
    currAcc = padcat(1, currAcc, segmentEpiduralType('Novice','CL') );
    currAcc = padcat(1, currAcc, segmentEpiduralType('Novice','CR') );
