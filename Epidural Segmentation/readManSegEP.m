...
function [transT transK] = readManSegEP(fileName,trial)
...
if (strcmp(trial,'Trial1'))
   position = 1; 
elseif (strcmp(trial,'Trial2'))
    position = 2;
elseif (strcmp(trial,'Trial3'))
    position = 3;
elseif (strcmp(trial,'Trial4'))
    position = 4;
elseif (strcmp(trial,'Trial5'))
    position = 5;
elseif (strcmp(trial,'Trial6'))
    position = 6;
end
