...
classdef MarkovDataLDA
    ...
    methods
        ...
        function C_Current = currentCluster(M)
            ...
            DL_Current = DO_Current.ldaTransform(M.PC.get('Trans'));
            
            %Determine the cluster to which the data point belongs
            DC_Current = DL_Current.findCluster(M.PC.get('Centroids'),M.PC.get('Weight'));
