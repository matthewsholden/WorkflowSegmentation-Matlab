...
%Return stepNum: A matrix containing the number of steps over which each
%parameter shall be iterated
%REturn stepValue: A cell array indicating the value of each step over
%which the parameters are iterated
function [stepNum stepValue] = readTP_Opt()
