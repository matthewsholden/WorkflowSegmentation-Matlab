%This function determines whether or not task 3 is being executed
...
%is being executed
function task = isTask3(x,v,t,in,ET)

%Task 3: Needle inside, velocity in the -ET direction above some threshold
...
%2. Is the velocity of the needle in the -ET direction above some threshold
if (-dot(v(1:3),ET)/norm(ET) < t(3))
   return; 
end
