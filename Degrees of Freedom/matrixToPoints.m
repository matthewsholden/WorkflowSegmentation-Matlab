...
%Parameter length: The length of the needle
%Parameter ref: A unit reference vector from which all rotations are applied

%Return x1: The point of the needle tip in xyz-space
%Return x2: The point of the needle end in xyz-space
function [x1 x2] = matrixToPoints(xt,R,needleLength,ET)
